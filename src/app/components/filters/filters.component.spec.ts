...
describe('FiltersComponent', () => {
  ...
  let mockFilterService, mockPinService, mockStateService,
    mockRouter, mockSearchBar, mockOnlineOrPhysicalGroupComponent;
  ...
  beforeEach(() => {
    ...
    TestBed.configureTestingModule({
      ...
      providers: [
        ...
        { provide: OnlineOrPhysicalGroupComponent, useValue: mockOnlineOrPhysicalGroupComponent}
      ],
  ...
  it('should apply filters', () => {
    this.comp.onlineOrPhysicalGroupComponent = jasmine.createSpyObj<OnlineOrPhysicalGroupComponent>('onlineOrPhysicalGroupComponent', ['getIsVirtualGroup']);
  ...
  it('should switch to list view when the online groups filter is applied', () => {
    this.comp.onlineOrPhysicalGroupComponent = jasmine.createSpyObj<OnlineOrPhysicalGroupComponent>('onlineOrPhysicalGroupComponent', ['getIsVirtualGroup']);

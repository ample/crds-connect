...
export class GatheringRequestsComponent implements OnInit {
  ...
  public ngOnInit() {
    this.groupInquiryService
      .getGroupRequests(this.pin.gathering.groupId)
      .finally(() => {
        this.loading = false;
      })
      .subscribe(
  ...
  public acceptOrDenyInquiry(inquiry: Inquiry, approve: boolean) {
    ...
    this.groupInquiryService
      .acceptOrDenyRequest(this.pin.gathering.groupId, this.pin.gathering.groupTypeId, approve, inquiry)
      .finally(() => {

...
export class GatheringEditComponent implements OnInit {
      ...
      .subscribe(
        ...
        error => {
          this.content
            ...
            .subscribe(message => this.toastr.error(message.content));
        }
      );
  }
  ...
  public doPinAndGatheringHaveSameAddress(pin: Pin): boolean {
    return (
      pin.address.addressLine1 === pin.gathering.address.addressLine1 &&
    ...
    this.pinService
      ...
      .subscribe(
        pin => {
          ...
          this.content
            .getContent('finderGatheringSavedSuccessfully')
            .subscribe(message => this.toastr.success(message.content));
          this.pin = pin;

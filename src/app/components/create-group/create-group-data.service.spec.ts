...
describe('CreateGroupDataService', () => {
  let service;
  let mockLookupService, mockSessionService, mockProfileService, mockParticipantService, mockRouter;
  ...
  it(
    'should create the create group service',
  ...
  it(
    'should initialize page one from uninitialized state',
    inject([CreateGroupService], (s: CreateGroupService) => {
  ...
  it(
    'should initialize page one from initialized state',
    inject([CreateGroupService], (s: CreateGroupService) => {
      const categories = MockTestData.getSomeCategories();
  ...
  it(
    'should validate selected groups and return valid as true and set selectedCategories',
    inject([CreateGroupService], (s: CreateGroupService) => {
      const categories = MockTestData.getSomeCategories();
      s.categories = categories;
      s['pageOneInitialized'] = true;
  ...
  it(
    'should validate selected groups and return valid as false',
    inject([CreateGroupService], (s: CreateGroupService) => {
      const categories = MockTestData.getSomeCategories();
      s.categories = categories;
      s['pageOneInitialized'] = true;
  ...
  it(
    'should add attributes to group model',
    inject([CreateGroupService], (s: CreateGroupService) => {
      const categories = MockTestData.getSomeCategories();
      ...
      expect(s.group.attributeTypes[attributeTypes.GroupCategoryAttributeTypeId].attributeTypeId).toBe(
  ...
  it(
    'should add groupGenderMixType to groupModel',
    inject([CreateGroupService], (s: CreateGroupService) => {
  ...
  it(
    'should add ageRanges to groupModel',
    inject([CreateGroupService], (s: CreateGroupService) => {
  ...
  it(
    'should create pin from group and profile data',
    inject([CreateGroupService], (s: CreateGroupService) => {
  ...
  it(
    'should set participants to an array with the leader you pass in',
    inject([CreateGroupService], (s: CreateGroupService) => {
  ...
  it(
    'should prepare group for submission isVirtualGroup false',
    inject([CreateGroupService], (s: CreateGroupService) => {
      s.group = MockTestData.getAGroup();
  ...
  it(
    'should prepare group for submission isVirtualGroup true',
    inject([CreateGroupService], (s: CreateGroupService) => {
      s.group = MockTestData.getAGroup();
      s.group.address = MockTestData.getAnAddress();
  ...
  it(
    'should format times and dates flexible meeting schedule',
    inject([CreateGroupService], (s: CreateGroupService) => {
  ...
  it(
    'should format times and dates specific meeting schedule',
    inject([CreateGroupService], (s: CreateGroupService) => {
      let categories = MockTestData.getSomeCategories();
      let group = MockTestData.getAGroup();
      group.attributeTypes = {};
  ...
  it(
    'should set group fields from group being edited',
    inject([CreateGroupService], (s: CreateGroupService) => {

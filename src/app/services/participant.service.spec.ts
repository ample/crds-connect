...
describe('ParticipantService', () => {
  ...
  beforeEach(() => {
    mockSessionService = jasmine.createSpyObj<SessionService>('session', [
      'get',
      'getWithoutMappingReturnedData',
      'getContactId',
      'post'
    ]);

    TestBed.configureTestingModule({
      providers: [ParticipantService, { provide: SessionService, useValue: mockSessionService }]
    });
  });

  describe('getGroupParticipant', () => {
    it(
      'should call getParticipants',
      inject([ParticipantService], (participantService: ParticipantService) => {
        spyOn(participantService, 'getParticipants').and.returnValue(
          Observable.of(MockTestData.getAParticipantsArray())
        );
    ...
    it(
      'should handle participant not found',
      inject([ParticipantService], (participantService: ParticipantService) => {
        spyOn(participantService, 'getParticipants').and.returnValue(
          Observable.of(MockTestData.getAParticipantsArray())
        );
        participantService.getGroupParticipant(32, 9999).subscribe(
          result => {},
          error => {
  ...
  describe('ClearGroupFromCache', () => {
    ...
    it(
      'should not clear(any)GroupFromCache because groupId is null',
      inject([ParticipantService], (service: ParticipantService) => {
        let cache: Array<Group> = new Array<Group>();
        let userId: 123;
        <jasmine.Spy>mockSessionService.getContactId.and.returnValue(123);
    ...
    it(
      'should not clear(any)GroupFromCache because cache is null',
      inject([ParticipantService], (service: ParticipantService) => {
        let cache: null;
        let userId: 123;
        <jasmine.Spy>mockSessionService.getContactId.and.returnValue(123);
  ...
  describe('getCurrentUserGroupRole', () => {
    ...
    it(
      'should return current users is leader',
      inject([ParticipantService], (service: ParticipantService) => {
        let cache: Array<Group> = new Array<Group>();
        let result;
        for (var i = 1; i < 11; i++) {
        ...
        service.getCurrentUserGroupRole(groupId).subscribe(userRole => {
          result = userRole;
        });
    ...
    it(
      'should return current users is not in group',
      inject([ParticipantService], (service: ParticipantService) => {
        let cache: Array<Group> = new Array<Group>();
        let result;
        for (var i = 1; i < 11; i++) {
    ...
    it(
      'should return current users is not in group because group does not exit',
      inject([ParticipantService], (service: ParticipantService) => {
        let cache: Array<Group> = new Array<Group>();
        let result;
        for (var i = 1; i < 11; i++) {
  ...
  describe('getAllLeaders', () => {
    ...
    xit(
      'should return 3 users as leaders',
      inject([ParticipantService], (service: ParticipantService) => {
        let cache: Array<Group> = new Array<Group>();
        let userId: 123;
        ...
        service.getAllLeaders(groupId).subscribe(participants => {
          result = participants;
          expect(console.log).not.toHaveBeenCalled();
    ...
    it(
      'should not return any leaders, group not found',
      inject([ParticipantService], (service: ParticipantService) => {
        let cache: Array<Group> = new Array<Group>();
        let userId: 123;
        let result: Array<Participant>;
  ...
  describe('getParticipants', () => {
    ...
    it(
      'should getParticipants from backend - notCachedForUser',
      inject([ParticipantService], (service: ParticipantService) => {
        let cache: Array<Group> = new Array<Group>();
        let userId: 123;
        let result;
    ...
    it(
      'should getParticipants from backend and add it to the cache - groupNotFound',
      inject([ParticipantService], (service: ParticipantService) => {
        let cache: Array<Group> = new Array<Group>();
        let userId: 123;
        let result;
  ...
  describe('should check if the user leads any groups', () => {
    it(
      'should check if the user leads any groups',
      inject([ParticipantService], (service: ParticipantService) => {
        let userId: 123;
        <jasmine.Spy>mockSessionService.getContactId.and.returnValue(userId);
    ...
    it(
      'should NOT make the call if userId is null',
      inject([ParticipantService], (service: ParticipantService) => {
